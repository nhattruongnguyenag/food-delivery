...
public class ProductRecyvlerViewAdapter_Hanh extends RecyclerView.Adapter<ProductRecyvlerViewAdapter_Hanh.ProductItemHolder> {
    ...
    public ProductRecyvlerViewAdapter_Hanh(@NonNull Activity activity, int layout, @NonNull List<ProductModel> listProducts) {
