...
public class MyCartRecycleViewAdapter_Hanh extends RecyclerView.Adapter<MyCartRecycleViewAdapter_Hanh.MyViewHolder> {
    ...
    public MyCartRecycleViewAdapter_Hanh(Activity activity, int layout_id, ArrayList<CartModel_Hanh> arrayList) {
    ...
    public void deleteButtonEventClick(MyViewHolder holder, CartModel_Hanh cart) {
    ...
    public void createAlertDialog(CartModel_Hanh cart) {
    ...
    public void btnPlustClickEvent(MyViewHolder holder, CartModel_Hanh cart) {
    ...
    public void btnSubClickEvent(MyViewHolder holder, CartModel_Hanh cart) {
    ...
    public void changeQtyProductInCart(int type, CartModel_Hanh cart) {
        int index = -1;
        if (FileUtils.cartList == null) {
