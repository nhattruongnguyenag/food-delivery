...
//    public static final String SERVER_IP = "http://192.168.1.250";
    ...
    public static final String MSG_USER_NOT_EXISTS = "Khong tim thay user";
    public static final String MSG_EMAIL_IS_EXIST = "email da ton tai , khong the them";
}
