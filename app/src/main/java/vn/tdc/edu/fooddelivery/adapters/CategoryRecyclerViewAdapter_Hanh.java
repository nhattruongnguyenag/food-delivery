...
public class CategoryRecyclerViewAdapter_Hanh extends RecyclerView.Adapter<CategoryRecyclerViewAdapter_Hanh.CategoryItemHolder> {
    private AppCompatActivity activity;
    private int layout;
    private List<CategoryModel_Hanh> listCategories;
    ...
    public CategoryRecyclerViewAdapter_Hanh(@NonNull AppCompatActivity activity, int layout, @NonNull List<CategoryModel_Hanh> listCategories) {
    ...
    public void onBindViewHolder(@NonNull CategoryItemHolder holder, int position) {
        CategoryModel_Hanh categoryModel = listCategories.get(position);
