...
public class MyNotificationRecyclerViewAdapter_Hanh extends RecyclerView.Adapter<MyNotificationRecyclerViewAdapter_Hanh.MyViewHolder> {
    private Activity activity;
    private int layout_ID;
    private ArrayList<NotificationModel_Hanh> arrayList;
    //B2: Definition variable
    private onRecyclerViewOnClickListener onRecyclerViewOnClickListener;

    public MyNotificationRecyclerViewAdapter_Hanh(Activity activity, int layout_ID, ArrayList<NotificationModel_Hanh> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        NotificationModel_Hanh notification = arrayList.get(position);
    ...
    public void setOnRecyclerViewOnClickListener(MyNotificationRecyclerViewAdapter_Hanh.onRecyclerViewOnClickListener onRecyclerViewOnClickListener) {
