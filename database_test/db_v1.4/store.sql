...
-- Thời gian đã tạo: Th5 25, 2023 lúc 12:10 PM
...
INSERT INTO `notifycations` (`id`, `title`, `image`, `content`, `user_id`, `status`, `created_at`, `updated_at`) VALUES
(1, 'dgd', NULL, 'hdhd', 2, 0, '2023-05-25 05:04:24', '2023-05-25 05:04:24'),
(2, 'dgd', 'fgfg', 'hdhd', 2, 1, '2023-05-25 05:05:54', '2023-05-25 05:09:04');
...
INSERT INTO `orders` (`id`, `delivery_address`, `customer_phone`, `total`, `user_id`, `shipper_id`, `status`, `created_at`, `updated_at`) VALUES
(1, 'hsdh', '455436', 2880000, 2, NULL, 1, '2023-05-24 00:42:25', '2023-05-24 00:42:25');
...
INSERT INTO `order_product` (`id`, `order_id`, `product_id`, `price`, `quantity`) VALUES
(1, 1, 1, 120000, 12),
(2, 1, 1, 120000, 24);
...
INSERT INTO `products` (`id`, `name`, `image`, `quantity`, `price`, `description`, `type`, `created_at`, `updated_at`) VALUES
(1, 'San pham 1', '1683823437.jpg', 10, 120000, 'Chưa có mô tả', 'phần', '2023-05-11 09:43:57', '2023-05-11 09:43:57');
...
INSERT INTO `product_user` (`id`, `user_id`, `product_id`, `quantity`) VALUES
(1, 2, 1, 24);
...
(1, 'Nguyen Van A', 'image', 'gdgd', 'eyJpdiI6IitSZnlZYVVZc1NtYyszQTEzYlpId0E9PSIsInZhbHVlIjoicTBjVzUwZzlsRHNadjZjWFVXZ0tkUT09IiwibWFjIjoiMGM3MDk4OTgzNWVmZjNlNzU0ODQ3ZWI5NTRiNzFiZGM2MTJmNjczNGRiZTIyMmIxY2ViODM3NWI1YzRhNDViZCIsInRhZyI6IiJ9', 1, '2023-05-11 05:02:23', '2023-05-11 10:46:51'),
...
(4, 'Trường Nguyễn', 'user_image_default.png', 'nhattruongnguyenag@gmail.com', 'eyJpdiI6ImlXRkY5dDlFbEVwNHNOaENQcTh5R0E9PSIsInZhbHVlIjoicEtVTGN6RENqSXVoYklWYVE5VDMvdz09IiwibWFjIjoiYTA0NDk0MDE0MzAwNzlmN2RmNGQxNzg0Njg4NDI0Y2RhNmE4NGQ4ZTYzMTMxM2M5YmJkMTNmY2RiYTJlNWMyMCIsInRhZyI6IiJ9', 1, '2023-05-11 10:29:43', '2023-05-11 10:29:43');
